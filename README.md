# cloudflare-ufw
Script to allow Cloudflare IPs with ports using ufw.
...
``` git clone git@github.com:klaucr/cloudflare-ufw ```

If you dont want to open all [Cloudflare supported ports](https://developers.cloudflare.com/fundamentals/get-started/reference/network-ports/), but only some of them, simple edit the cloudflare-ufw file and remove ports from line 10. For example to allow only 80 and 443 ports:
```
declare -a allowCloudflarePorts=("80" "443")
```

Run the bash script in the normal manner;
...
This concept was originally [developed by Leow Kah Man](https://www.leowkahman.com/2016/05/02/automate-raspberry-pi-ufw-allow-cloudflare-inbound/) and improved by [klaucr](https://github.com/klaucr/)